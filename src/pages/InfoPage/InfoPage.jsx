...
export const infoloader = async () => {
	...
	if (key) {
		...
		return { item, item2, exchangerInfo };
	} else {
...
export const InfoPage = () => {
	...
	const { exchangerInfo } = useLoaderData();
	...
	const postUrl = () => {
		...
		axios
			...
			.then(function (response) {
				setnewUrl(response.data.data.xml_url);
				setChangeUrl(false)
			});
	};
		...
		<div className={'section-wrapper'}>
			<div className={'container-full'}>
				<div className="row">
					...
					<main className={style.infoPage__main + ' col-md-8 col-lg-9'}>
						<div className={style.infoPage__mainContainer + ' row'}>
										...
										<div className={style.infoPage__mainContainer__moreInfo__box}>
											...
											>
												...
												{changeUrl === true ? (
													...
													<div className={style.infoPage__mainContainer__changeUrl}>
														<a style={{ opacity: "0.5", textDecoration: "underline", color: '#a2a2a3' }} href={newUrl != "" ? newUrl : item2.data.xml_url}>
															{newUrl != "" ? newUrl : item2.data.xml_url}
														</a>
														<img
															onClick={openChangeUrlValue}
															className={style.infoPage__mainContainer__changeUrl__btn}
